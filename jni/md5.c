...
JNIEXPORT jstring JNICALL Java_com_example_security_MD5_mdString(
		JNIEnv *env, jobject obj, jstring str) {
	MD5_CTX mdContext;
	char *inString = (*env)->GetStringUTFChars(env, str, NULL);
...
JNIEXPORT jstring JNICALL Java_com_example_security_MD5_mdFile(
		JNIEnv *env, jobject obj, jstring str) {
	char *filename = (*env)->GetStringUTFChars(env, str, NULL);
